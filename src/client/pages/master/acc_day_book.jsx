...
export default function AccDayBook() {
  ...
  async function openCreate() {
    ...
    try {
      const next = await invoke("get_next_master_code", { table: "day_book" });
          ...
          <form onSubmit={handleSubmit} onKeyDown={enterNav} className="space-y-4">
            ...
            <Field>
              ...
              <SearchableSelect
                ...
                onSelect={(v) => setF("groupCode", v || null)}
            ...
            <Field>
              ...
              <SearchableSelect
                options={ledgers.map((l) => ({ value: String(l.id), label: l.name }))}
                value={form.genLegCode ? String(form.genLegCode) : ""}
                onSelect={(v) => setF("genLegCode", v || null)}
