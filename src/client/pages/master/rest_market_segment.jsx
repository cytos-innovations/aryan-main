...
// Restaurant dineout-app market segments (Swiggy, Zomato, District, Magicpin…).
...
export default function RestMarketSegment() {
  ...
  const query = useQuery({
    queryKey: [...QK, qs],
    queryFn: () => invoke("get_market_segments", { qs, segmentType: SEGMENT_TYPE }),
  ...
  const deleteMut = useMutation({
    ...
    onSuccess: () => { toast.success("Dineout app deleted"); inv(); setDeleteTarget(null); },
    onError: (e) => toast.error(String(e)),
  });
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-0.5">
          <Can perm="rest-market-segment:update">
            <Tooltip>
          ...
          <Can perm="rest-market-segment:delete">
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
  ...
  return (
    <TooltipProvider>
      <div className="p-6">
        <Card>
          <CardHeader><CardTitle>Dineout Apps (Market Segments)</CardTitle></CardHeader>
          <CardContent>
            <DataTable
              columns={columns}
              ...
              emptyText="No dineout apps found."
              toolbar={
                <Can perm="rest-market-segment:add">
      ...
      <Dialog open={dialog.open} onOpenChange={(o) => !o && closeDialog()}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            <DialogTitle>
              {dialog.mode === "create" ? "New Dineout App" : "Edit Dineout App"}
            </DialogTitle>
            <DialogDescription>
              {dialog.mode === "create"
                ? "Add a dineout app used for discounts (Swiggy, Zomato, District…)."
                : "Update this dineout app."}
            </DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={!!deleteTarget} onOpenChange={(o) => !o && setDeleteTarget(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Dineout App</AlertDialogTitle>
