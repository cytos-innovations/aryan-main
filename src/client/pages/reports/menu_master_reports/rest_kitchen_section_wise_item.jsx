...
// Kitchen Section wise Item — scaffold page (report logic to be implemented).
export default function KitchenSectionWiseItem() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_kitchen_section_wise_item"],
    queryFn: () => invoke("get_kitchen_section_wise_item"),
  });
