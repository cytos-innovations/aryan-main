...
// Liquor Group — scaffold page (report logic to be implemented).
export default function LiquorGroup() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_liquor_group"],
    queryFn: () => invoke("get_liquor_group"),
  });
