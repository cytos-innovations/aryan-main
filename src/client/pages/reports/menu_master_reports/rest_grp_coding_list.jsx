...
// Grp. Coding List — scaffold page (report logic to be implemented).
export default function GrpCodingList() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_grp_coding_list"],
    queryFn: () => invoke("get_grp_coding_list"),
  });
