...
// Menu Deluxe Rate — scaffold page (report logic to be implemented).
export default function MenuDeluxeRate() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_menu_deluxe_rate"],
    queryFn: () => invoke("get_menu_deluxe_rate"),
  });
