...
// Kot Message Code — scaffold page (report logic to be implemented).
export default function KotMessageCode() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_kot_message_code"],
    queryFn: () => invoke("get_kot_message_code"),
  });
