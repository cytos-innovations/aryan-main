...
// Grp. Item Price — scaffold page (report logic to be implemented).
export default function GrpItemPrice() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_grp_item_price"],
    queryFn: () => invoke("get_grp_item_price"),
  });
