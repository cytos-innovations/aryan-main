...
// Codewise Menu — scaffold page (report logic to be implemented).
export default function CodewiseMenu() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_codewise_menu"],
    queryFn: () => invoke("get_codewise_menu"),
  });
