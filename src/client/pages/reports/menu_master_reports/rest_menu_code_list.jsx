...
// Menu Code List — scaffold page (report logic to be implemented).
export default function MenuCodeList() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_menu_code_list"],
    queryFn: () => invoke("get_menu_code_list"),
  });
