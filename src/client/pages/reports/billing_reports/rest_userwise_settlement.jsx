...
// Userwise Settlement — scaffold page (report logic to be implemented).
export default function UserwiseSettlement() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_userwise_settlement"],
    queryFn: () => invoke("get_userwise_settlement"),
  });
