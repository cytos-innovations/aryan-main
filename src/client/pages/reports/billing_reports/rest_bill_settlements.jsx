...
// Bill Settlements — scaffold page (report logic to be implemented).
export default function BillSettlements() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_bill_settlements"],
    queryFn: () => invoke("get_bill_settlements"),
  });
