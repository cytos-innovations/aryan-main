...
// Billwise Cancel — scaffold page (report logic to be implemented).
export default function BillwiseCancel() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_billwise_cancel"],
    queryFn: () => invoke("get_billwise_cancel"),
  });
