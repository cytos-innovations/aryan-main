...
// KOT Detail Report — scaffold page (report logic to be implemented).
export default function KotDetailReport() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_kot_detail_report"],
    queryFn: () => invoke("get_kot_detail_report"),
  });
