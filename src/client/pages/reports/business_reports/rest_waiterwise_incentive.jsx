...
// Waiterwise Incentive — scaffold page (report logic to be implemented).
export default function WaiterwiseIncentive() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_waiterwise_incentive"],
    queryFn: () => invoke("get_waiterwise_incentive"),
  });
