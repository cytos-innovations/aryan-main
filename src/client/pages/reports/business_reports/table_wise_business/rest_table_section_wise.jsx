...
// Table Section wise — scaffold page (report logic to be implemented).
export default function TableSectionWise() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_table_section_wise"],
    queryFn: () => invoke("get_table_section_wise"),
  });
