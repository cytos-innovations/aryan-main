...
// Waiterwise Report — scaffold page (report logic to be implemented).
export default function WaiterwiseReport() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_waiterwise_report"],
    queryFn: () => invoke("get_waiterwise_report"),
  });
