...
// Waiterwise Sale — scaffold page (report logic to be implemented).
export default function WaiterwiseSale() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_waiterwise_sale"],
    queryFn: () => invoke("get_waiterwise_sale"),
  });
