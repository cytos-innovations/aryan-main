...
// Custom MIS Reports — scaffold page (report logic to be implemented).
export default function CustomMisReports() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_custom_mis_reports"],
    queryFn: () => invoke("get_custom_mis_reports"),
  });
