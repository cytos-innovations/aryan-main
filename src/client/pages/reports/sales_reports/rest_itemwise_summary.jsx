...
// Itemwise Summary — scaffold page (report logic to be implemented).
export default function ItemwiseSummary() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_itemwise_summary"],
    queryFn: () => invoke("get_itemwise_summary"),
  });
