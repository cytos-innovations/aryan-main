...
// Categorywise Sale — scaffold page (report logic to be implemented).
export default function CategorywiseSale() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_categorywise_sale"],
    queryFn: () => invoke("get_categorywise_sale"),
  });
