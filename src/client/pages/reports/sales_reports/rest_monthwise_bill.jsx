...
// Monthwise Bill — scaffold page (report logic to be implemented).
export default function MonthwiseBill() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_monthwise_bill"],
    queryFn: () => invoke("get_monthwise_bill"),
  });
