...
// Rate Wise Sale — scaffold page (report logic to be implemented).
export default function RateWiseSale() {
  const { data, isLoading, error } = useQuery({
    queryKey: ["report", "get_rate_wise_sale"],
    queryFn: () => invoke("get_rate_wise_sale"),
  });
